...
Ecrivez un programme qui lit avec n = int(input()) une valeur n donnée (n supérieure ou égal à 2) et imprime sur une ligne, les n premiers nombres de Fibonacci (F0 à Fn-1), en mettant un espace après chaque nombre et une fin de ligne à la fin.
